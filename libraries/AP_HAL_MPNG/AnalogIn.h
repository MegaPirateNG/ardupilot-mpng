...
#ifndef __AP_HAL_MPNG_ANALOG_IN_H__
#define __AP_HAL_MPNG_ANALOG_IN_H__
...
class MPNG::ADCSource : public AP_HAL::AnalogSource {
public:
    friend class MPNG::AVRAnalogIn;
...
#endif // __AP_HAL_MPNG_ANALOG_IN_H__
