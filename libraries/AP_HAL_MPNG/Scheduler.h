...
#ifndef __AP_HAL_MPNG_SCHEDULER_H__
#define __AP_HAL_MPNG_SCHEDULER_H__
...
class MPNG::AVRScheduler : public AP_HAL::Scheduler {
public:
    AVRScheduler();
    /* AP_HAL::Scheduler methods */

    /* init: implementation-specific void* argument expected to be an
     * AP_HAL_MPNG::ISRRegistry*. */
...
#endif // __AP_HAL_MPNG_SCHEDULER_H__
