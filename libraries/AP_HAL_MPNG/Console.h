...
#ifndef __AP_HAL_MPNG_CONSOLE_DRIVER_H__
#define __AP_HAL_MPNG_CONSOLE_DRIVER_H__
...
class MPNG::AVRConsoleDriver : public AP_HAL::ConsoleDriver {
public:
...
#endif // __AP_HAL_MPNG_CONSOLE_DRIVER_H__
